...
[`rust-project-setup.md`](rust-project-setup.md), and
...
- [`test-coverage-for-porting.md`](test-coverage-for-porting.md) for source parity
- `tbd guidelines general-testing-rules general-tdd-guidelines golden-testing-guidelines error-handling-rules`
