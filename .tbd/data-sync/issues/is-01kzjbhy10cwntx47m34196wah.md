---
type: is
id: is-01kzjbhy10cwntx47m34196wah
title: Create the standalone Rust guideline suite
kind: task
status: closed
priority: 1
version: 5
...
---
Create or refocus rust-rules, rust-project-setup, rust-cli-rules, rust-filesystem-rules, rust-testing-rules, rust-release-rules, and rust-code-review-rules. Give each one authoritative scope and tbd-ready metadata.
